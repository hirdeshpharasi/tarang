...
void IncFluid::Init_cond_ABC()
{
	...
	if (basis_type == "FOUR")
	{
		...
		DP A = (*init_cond_para)(2);
		DP B = (*init_cond_para)(3);
		DP C = (*init_cond_para)(4);
		DP amp = (*init_cond_para)(5);
...
void  IncFluid::Init_cond_ABC(string Pr_switch, IncSF& T)
{
...
void  IncFluid::Init_cond_ABC(string Pr_switch, IncVF& W, IncSF& T)
{
