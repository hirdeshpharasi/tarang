...
)
{
	...
	Local_shell_mult_single_real_imag_FOUR(alias_switch, N, A, B, inner_radius, outer_radius, 
...
)
{
	...
	Local_shell_mult_all_real_imag_FOUR(alias_switch, N, A, B, shell_radius_array, 
										local_result_real, local_result_imag, kfactor);
...
)
{
	...
	Local_shell_mult_all_real_imag_FOUR(alias_switch, N, Ax, Ay, Az, Bx, By, Bz, 
...
)
{
	...
	Local_ring_mult_all_real_imag_FOUR(alias_switch, N, A, B, shell_radius_array, 
...
)
{
	...
	Local_ring_mult_all_real_imag_FOUR(alias_switch, N, Ax, Ay, Az, Bx, By, Bz, 
...
)
{
	...
	Local_cyl_ring_mult_all_real_imag_FOUR(alias_switch, N, A, B, cylinder_shell_radius_array, 
...
)
{
	...
	Local_cyl_ring_mult_all_real_imag_FOUR(alias_switch, N, Ax, Ay, Az, Bx, By, Bz, 
