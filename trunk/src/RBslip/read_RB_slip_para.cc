...
/*! \file RB_slip_main.h
 * 
 * @brief Reads parameters related to RB convection (Pr, r, q/k0. Pr_switch, and Uscaling).
 *
 * @author  M. K. Verma
 * @date 2 October 2008
 * 
...
)
{
	...
	RB_slip_para_file >> Pr >> r >> qbyk0;	
		
	if (my_id == master_id)		
		cout << "	Pr, r, q/k0: " << Pr << " "  << r << " " << qbyk0  << endl << endl;
